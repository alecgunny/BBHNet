...
class PerfSummaryPlot:
            ...
            if x_axis_type == "FAR":
                ...
                if hist_type == "Binned":
                    ...
                    if x_axis_type == "SNR":
                        ...
                        detected_counts, _ = np.histogram(detected, bins=snr_bins)
                        ...
                        detected_counts, _ = np.histogram(detected, bins=dist_bins)
    ...
    def switch_x_axis(self, attr, old, new):
        ...
        if new == "FAR":
            ...
            self.p.title.text = f"Efficiency vs. Distance ({self.hist_type_select.value})"
